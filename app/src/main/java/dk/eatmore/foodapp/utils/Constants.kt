...
class Constants {
    ...
    const  val ORDER_DISCOUNT="Order Discount"
    ...
    const  val EATMORE_GIFTCARD="eatmore_giftcard"
    const  val RESTAURANT_GIFTCARD="restaurant_giftcard"
    ...
    const  val CHECKOUT_PAYMENT="checkout_payment"
    ...
    const  val ADDITIONAL_CHARGES_GIFTCARD="additional_charges_giftcard"
    const  val USER_DISTANCE="user_distance"
    const  val SHIPPING_REMARK="shipping_remark"
    const  val GIFTCARD="Giftcard"
    const  val COUPON="Coupon"
    const  val EATMORE_COUPON="EatMore Coupon"
    const  val RESTAURANT_COUPON="Restaurant Coupon"
