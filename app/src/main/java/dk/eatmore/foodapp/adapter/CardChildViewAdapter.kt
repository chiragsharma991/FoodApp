...
class CardChildViewAdapter(val context: Context,val listner : CartViewAdapter.AdapterListener,val parentPosition:Int,val list_child :ArrayList<User>): RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
       // (holder as MyViewHolder).binding
        if(holder is MyViewHolder){
            ...
            holder.binding.rowCartChildTxt.text=list_child[position].name
